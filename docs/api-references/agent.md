...
|--------------------|----------|----------|----------------------------------------------------------------|
| `agent`            | string   | No       | Optional descriptive label persisted to the run record. Provider/model selection is server-side only (see `agent.olium.*` in `vigolium-configs.yaml`). |
